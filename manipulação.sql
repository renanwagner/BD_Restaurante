...
SELECT * FROM info_profutos;
SELECT * FROM pedidos;

-- Inserindo os dados de funcionários
INSERT INTO funcionarios 
VALUES (NULL,'Ricardo Sousa', '111.222.333-44', '1992-12-05', 'Rua Harmonia 157, São Paulo', '11987651234', 'ricardo.sousa@email.com', 'Chefe de Cozinha', 6000.00, '2019-03-15');
INSERT INTO funcionarios
VALUES (NULL, 'Lívia Castro', '222.333.444-55', '1989-11-25', 'Av. Rebouças 1234, São Paulo', '11987653421', 'livia.castro@email.com', 'Subgerente', 5500.00, '2021-06-20'),
		(NULL, 'Marcos Lima', '333.444.555-66', '1985-04-17', 'Rua Augusta 2020, São Paulo', '11987655678', 'marcos.lima@email.com', 'Barman', 2800.00, '2022-01-10'),
        (NULL, 'Carla Mendes', '444.555.666-77', '1993-07-03', 'Av. Paulista 1853, São Paulo', '11987659876', 'carla.mendes@email.com', 'Atendente', 2600.00, '2022-07-15'),
        (NULL, 'Tiago Nunes', '555.666.777-88', '1978-08-12', 'Rua Funchal 500, São Paulo', '11987656789', 'tiago.nunes@email.com', 'Sommelier', 3400.00, '2023-04-22'),
		(NULL, 'Cláudia Vieira', '666.777.888-99', '1981-01-19', 'Alameda Lorena 1300, São Paulo', '11987657890', 'claudia.vieira@email.com', 'Cozinheira', 3200.00, '2023-08-30'),
		(NULL, 'Pedro Martins', '777.888.999-00', '1983-12-05', 'Rua dos Pinheiros 800, São Paulo', '11987658901', 'pedro.martins@email.com', 'Garçom', 2700.00, '2024-03-15'),
		(NULL, 'Fernanda Rocha', '888.999.000-11', '1990-09-27', 'Av. Faria Lima 1500, São Paulo', '11987659012', 'fernanda.rocha@email.com', 'Garçonete', 2700.00, '2024-05-20'),
		(NULL, 'André Costa', '999.000.111-22', '1986-03-14', 'Rua Bela Cintra 985, São Paulo', '11987660123', 'andre.costa@email.com', 'Gerente', 4700.00, '2024-10-10'),
		(NULL, 'Sofia Alves', '000.111.222-33', '1995-06-01', 'Rua Consolação 1235, São Paulo', '11987661234', 'sofia.alves@email.com', 'Recepcionista', 2400.00, '2025-01-01');
        
INSERT INTO clientes
VALUES (NULL, 'Lucas Silva', '123.456.789-01', '1990-01-15', 'Av. Brigadeiro Faria Lima, 1571, São Paulo', '11987651234', 'lucas.silva@email.com', '2023-01-12'),
...
VALUES (NULL, 'Feijoada', 'Feijoada completa com arroz, farofa, couve e laranja.', 29.90, 'Prato Principal'),
...
INSERT INTO info_produtos
VALUES (NULL, 1, 'Feijão preto, carne seca, costelinha, linguiça, arroz, farinha, couve, laranja', 'Distribuidora Central'),
...
INSERT INTO pedidos
VALUES (NULL, 1, 4, 1, 2, 59.80, '2024-07-01', 'Concluído'),
		(NULL, 3, 4, 2, 1, 42.00, '2024-07-01', 'Concluído'),
		(NULL, 6, 7, 3, 1, 37.50, '2024-07-01', 'Concluído'),
		(NULL, 8, 7, 4, 3, 135.00, '2024-07-01', 'Concluído'),
		(NULL, 10, 8, 5, 2, 76.00, '2024-07-02', 'Pendente'),
		(NULL, 15, 8, 6, 4, 26.00, '2024-07-02', 'Concluído'),
		(NULL, 22, 4, 7, 3, 15.00, '2024-07-02', 'Concluído'),
		(NULL, 18, 4, 8, 2, 10.00, '2024-07-02', 'Concluído'),
		(NULL, 4, 7, 9, 5, 30.00, '2024-07-02', 'Concluído'),
		(NULL, 6, 7, 10, 1, 36.00, '2024-07-03', 'Concluído'),
		(NULL, 9, 8, 11, 3, 64.00, '2024-07-03', 'Concluído'),
		(NULL, 11, 8, 12, 1, 22.00, '2024-07-03', 'Concluído'),
		(NULL, 24, 4, 13, 2, 56.00, '2024-07-03', 'Concluído'),
		(NULL, 27, 4, 14, 1, 35.00, '2024-07-03', 'Concluído'),
		(NULL, 17, 7, 15, 2, 84.00, '2024-07-03', 'Concluído'),
		(NULL, 7, 7, 16, 3, 45.00, '2024-07-04', 'Concluído'),
		(NULL, 13, 8, 17, 2, 16.00, '2024-07-04', 'Concluído'),
		(NULL, 25, 8, 18, 4, 30.00, '2024-07-04', 'Concluído'),
		(NULL, 22, 4, 19, 1, 12.00, '2024-07-04', 'Concluído'),
		(NULL, 2, 4, 20, 2, 10.00, '2024-07-04', 'Concluído'),
		(NULL, 8, 7, 2, 1, 42.00, '2024-07-04', 'Concluído'),
		(NULL, 11, 7, 3, 2, 75.00, '2024-07-05', 'Concluído'),
		(NULL, 18, 8, 4, 3, 135.00, '2024-07-05', 'Concluído'),
		(NULL, 22, 8, 5, 1, 38.00, '2024-07-05', 'Concluído'),
		(NULL, 19, 4, 6, 4, 26.00, '2024-07-05', 'Concluído'),
		(NULL, 28, 4, 7, 3, 15.00, '2024-07-05', 'Concluído'),
		(NULL, 1, 7, 8, 2, 10.00, '2024-07-05', 'Concluído'),
		(NULL, 7, 7, 9, 5, 30.00, '2024-07-05', 'Concluído'),
		(NULL, 19, 8, 10, 1, 36.00, '2024-07-05', 'Concluído'),
		(NULL, 15, 8, 11, 3, 96.00, '2024-07-05', 'Concluído'),
		(NULL, 24, 4, 12, 1, 22.00, '2024-07-05', 'Concluído'),
		(NULL, 12, 4, 13, 2, 56.00, '2024-07-05', 'Concluído'),
		(NULL, 4, 7, 14, 1, 35.00, '2024-07-05', 'Concluído'),
		(NULL, 9, 7, 15, 2, 84.00, '2024-07-06', 'Concluído'),
		(NULL, 18, 8, 16, 3, 45.00, '2024-07-06', 'Concluído'),
		(NULL, 5, 8, 17, 2, 16.00, '2024-07-06', 'Pendente'),
		(NULL, 22, 4, 18, 4, 30.00, '2024-07-06', 'Concluído'),
		(NULL, 14, 4, 19, 1, 12.00, '2024-07-06', 'Pendente'),
		(NULL, 19, 7, 20, 2, 20.00, '2024-07-06', 'Concluído'),
		(NULL, 8, 7, 1, 2, 58.90, '2024-07-06', 'Pendente'),
		(NULL, 7, 8, 2, 1, 42.00, '2024-07-06', 'Concluído'),
		(NULL, 4, 8, 3, 2, 75.00, '2024-07-06', 'Pendente'),
		(NULL, 21, 4, 4, 3, 135.00, '2024-07-06', 'Concluído'),
		(NULL, 4, 4, 5, 1, 38.00, '2024-07-06', 'Pendente'),
		(NULL, 13, 7, 6, 4, 26.00, '2024-07-06', 'Concluído'),
		(NULL, 25, 7, 7, 3, 15.00, '2024-07-06', 'Pendente'),
		(NULL, 7, 8, 8, 2, 10.00, '2024-07-06', 'Concluído'),
		(NULL, 7, 8, 8, 2, 10.00,'2024-07-06', 'Concluído'),
		(NULL, 12, 4, 10, 1, 36.00, '2024-07-06', 'Concluído'),
		(NULL, 10, 4, 11, 3, 64.00, '2024-07-06', 'Pendente');
